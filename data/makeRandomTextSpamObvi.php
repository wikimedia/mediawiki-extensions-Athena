<?php
    ...
    $names = array('Shari', 'Bree', 'Bette', 'Catalina', 'Timmy', 'Oscar', 'Steve Fischer', 'Gloria', 'Francesca', 'Glen Taverner', 'Brady Wharton', 'Tamie Turriff', 'Richard', 'Ellie', 'Frank Sinatra', 'Muhammad', 'Polly Pearson', 'Uscar', 'Mckenzie', 'Angus');
    $date = array('10 December 1984', '20 November 1999', '12 January 1987', '1 March 1977', '6 April 1976',
   ...
   $hobbies = array('porn', 'viagra', 'zoofilla', 'jerseys', 'cheap nfl jerseys','paris-hilton', 'huojia', 'casino-online', 'spycam', 'livegirl', 'camgirl', 'cheapairfares', 'online-casino', 'adultporn','fullcellmarket', 'teensex', 'hardcoreporn', 'teenporn', 's-e-x');
    ...
    for( $count = 0; $count < 250; $count++) {
        ...
        if( $count % 100 < 70 ){
            $age = 60;
        } else if ( $count % 100 < 80 ) { // 5
                    $age = 180;
                }  else if ( $count % 100 < 90 ) { // 30
                    $age = 60 * 15;
                } else if ( $count % 100 < 95 ) {
                    $age = 60 * 45;
    ...
    file_put_contents( 'page_data/spam3.json', json_encode( $output ) );